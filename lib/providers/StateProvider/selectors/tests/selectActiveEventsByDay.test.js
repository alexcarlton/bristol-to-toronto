...
describe("selectActiveEventsByDay", () => {
  it("should select events for the active calendars for the specified day", () => {
    ...
    const state = {
      ...
      events: {
        byCalendarId: {
          1: [{ id: "event-1", startTime: dayToSelectBy }, { id: "event-2" }],
          2: [{ id: "event-3" }, { id: "event-4", startTime: dayToSelectBy }],
    ...
    expect(
      ...
      { id: "event-1", startTime: dayToSelectBy },
      { id: "event-4", startTime: dayToSelectBy },
    ]);
  });
});
