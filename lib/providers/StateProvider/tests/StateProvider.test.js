...
import { addActiveCalendarId } from "../actions/addActiveCalendarId";
import { removeActiveCalendarId } from "../actions/removeActiveCalendarId";
...
describe("StateProvider", () => {
  ...
  it("should handle addActiveCalendarId action", () => {
    ...
    act(() => result.current.dispatch(addActiveCalendarId(calendarId)));
  ...
  it("should handle removeActiveCalendarId action", () => {
    const { result } = renderHook(() => useContext(StateContext), { wrapper });
    ...
    act(() => result.current.dispatch(removeActiveCalendarId(calendarId)));
