  ...
  [
    {
      id: "event-1",
      summary: "Event 1",
      start: DateTime.fromObject({ ...currentTime, day: 25, hour: 10 }),
      end: DateTime.fromObject({ ...currentTime, day: 25, hour: 11 }),
      backgroundColor: "red",
    },
    {
      id: "event-2",
      summary: "Event 2",
      start: DateTime.fromObject({ ...currentTime, day: 26, hour: 12 }),
      end: DateTime.fromObject({ ...currentTime, day: 26, hour: 13 }),
      backgroundColor: "red",
    },
  ],
  [
    {
      id: "event-3",
      summary: "Event 3",
      start: DateTime.fromObject({ ...currentTime, day: 27, hour: 14 }),
      end: DateTime.fromObject({ ...currentTime, day: 27, hour: 16 }),
      backgroundColor: "green",
    },
    {
      id: "event-4",
      summary: "Event 4",
      start: DateTime.fromObject({ ...currentTime, day: 29, hour: 16 }),
      end: DateTime.fromObject({ ...currentTime, day: 29, hour: 19 }),
      backgroundColor: "green",
    },
  ],
];
